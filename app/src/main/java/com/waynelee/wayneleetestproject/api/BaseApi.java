...
import com.waynelee.wayneleetestproject.util.NetUtils;
import com.waynelee.wayneleetestproject.util.ToastUtils;
...
public class BaseApi {
    ...
    public static <T> T createApi(Class<T> service) {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .client(ProjectApplication.getApplication().genericClient())
    ...
    public static <T> void request(Observable<T> observable,
        ...
        if (!NetUtils.isConnected(ProjectApplication.getApplication())) {
